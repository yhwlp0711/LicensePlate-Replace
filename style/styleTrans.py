...
#
#     image = loader(image).unsqueeze(0).to(device, torch.float)  # 需要伪造的批次尺寸以适合网络的输入尺寸
#     return image.to(device, torch.float)


# style_img = image_loader("./images/picasso.jpg")
# content_img = image_loader("./images/dancing.jpg")
# style_img = image_loader(r"E:\QQFile\787244876\787244876\FileRecv\CV\car\project2\Pytorch_Retina_License_Plate\test.jpg")
# content_img = image_loader(r"E:\QQFile\787244876\787244876\FileRecv\CV\car\project2\result\newA.jpg")
...
# styleImg = cv2.imread(r"E:\QQFile\787244876\787244876\FileRecv\CV\car\project2\Pytorch_Retina_License_Plate\test.jpg")
# ContentImg = cv2.imread(r"E:\QQFile\787244876\787244876\FileRecv\CV\car\project2\result\newA.jpg")
# temp = styleTran(ContentImg, styleImg)
# cv2.imshow('1',temp)
# cv2.waitKey(0)
